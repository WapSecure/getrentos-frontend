  ...
  return (
    <>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    <button
                      ...
                      disabled={!previewUrl}
                      className="text-xs text-primary hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-40"
                    >
                      Preview
                    </button>
                    <button
      ...
      <FilePreviewDialog
        ...
        file={previewUrl && file ? { url: previewUrl, name: file.name, mimeType: file.type } : null}
      />
    </>
  );
};
