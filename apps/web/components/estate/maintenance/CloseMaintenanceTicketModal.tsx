...
interface CloseMaintenanceTicketModalProps {
  isOpen: boolean;
...
export const CloseMaintenanceTicketModal = ({
  isOpen,
  action,
  onClose,
  onConfirm,
  isSubmitting,
}: CloseMaintenanceTicketModalProps) => {
  ...
  const title = action === 'dismiss' ? 'Dismiss Ticket' : 'Resolve Ticket';
