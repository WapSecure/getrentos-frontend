        ...
        <div className="flex-1">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-white/70 mb-8 leading-relaxed">
              Help us build a trusted community. Complete your verification to access all features,
              including escrow protection, property listings, and secure transactions.
            </p>
