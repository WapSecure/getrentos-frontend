    ...
    <RadixPopover.Root open={open} onOpenChange={setOpen}>
      ...
      <RadixPopover.Portal>
        <RadixPopover.Content
          sideOffset={6}
          align="start"
          className="z-[70] max-h-72 min-w-[var(--radix-popover-trigger-width)] overflow-auto rounded-xl border border-border bg-card p-1.5 shadow-[0_16px_40px_rgba(0,0,0,0.16)]"
        >
