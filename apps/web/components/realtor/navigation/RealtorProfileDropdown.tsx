...
interface RealtorProfileDropdownProps {
  user: { fullName: string; email: string } | null;
}

export const RealtorProfileDropdown = ({ user }: RealtorProfileDropdownProps) => {
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <RoleSwitcher currentRoleId="realtor" />
