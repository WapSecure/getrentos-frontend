...
export const MessageAttachments = ({
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <FilePreviewDialog open={previewIndex !== null} onOpenChange={(open) => !open && setPreviewIndex(null)} file={previewIndex === null ? null : { url: attachments[previewIndex].url, name: attachments[previewIndex].name, mimeType: attachments[previewIndex].type }} />
    </div>
  );
};
