  ...
  return (
    ...
    >
      <div className="p-4 border-b border-gray-200 dark:border-white/10">
        <h3 className="font-semibold text-gray-900 dark:text-white">Lease Details</h3>
        <p className="text-xs text-gray-500 dark:text-gray-400">Full lease agreement information</p>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="p-3 rounded-lg bg-gray-50 dark:bg-white/5">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">{lease.renewalTerms}</p>
        </div>
          ...
          <div className="p-3 rounded-lg bg-gray-50 dark:bg-white/5">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-white">{lease.landlord.name}</p>
