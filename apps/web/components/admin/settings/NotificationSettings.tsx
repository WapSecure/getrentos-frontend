...
const initialPreferences: NotificationPreference[] = [
  { id: 'fraud', label: 'Fraud Alerts', icon: ShieldAlert, email: true, push: true },
  { id: 'disputes', label: 'New & Escalated Disputes', icon: Gavel, email: true, push: true },
  {
    id: 'verifications',
  ...
  {
    id: 'escrow',
    label: 'Flagged Escrow Transactions',
    icon: AlertTriangle,
    email: true,
    push: true,
  },
  { id: 'messages', label: 'New Support Messages', icon: MessageCircle, email: false, push: true },
];
