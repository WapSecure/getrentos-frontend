...
export default function OwnerAnalyticsPage() {
  ...
  return (
    <>
      ...
      <ProFeatureGate
        title="Investment analytics is a Pro feature"
        description="Upgrade to Pro to see ROI, appreciation, and rental yield across your portfolio, plus market comparables."
      >
