...
const ROWS: ComparisonRow[] = [
  { label: 'Properties, sale listings, offers, transactions', free: true, pro: true },
  { label: 'Buyer leads & realtor access', free: true, pro: true },
  { label: 'Documents, messaging, reviews', free: true, pro: true },
  { label: 'Investment analytics (ROI, appreciation, market comparables)', free: false, pro: true },
    ...
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          See what&apos;s included on Free and what Pro unlocks for your portfolio.
        </p>
      </div>
