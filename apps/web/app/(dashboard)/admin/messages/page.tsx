...
const mockConversations: Conversation[] = [
  {
    ...
    participantRole: 'Buyer · Dispute #dp_001',
    lastMessage: 'Can someone review the inspection report I attached?',
    lastMessageTime: '2026-08-08T08:40:00.000Z',
    unreadCount: 2,
  },
  {
    id: 'conv_002',
    participantName: 'Segun Alabi',
    participantRole: 'Property Owner · Support',
    lastMessage: 'How long does property verification usually take?',
    lastMessageTime: '2026-08-07T14:10:00.000Z',
    unreadCount: 0,
  },
  {
    id: 'conv_003',
    participantName: 'Chidinma Nwosu',
    participantRole: 'Realtor · License Verification',
    lastMessage: 'Thank you for approving my license.',
    lastMessageTime: '2026-08-06T11:00:00.000Z',
    unreadCount: 0,
  },
  {
    id: 'conv_004',
    participantName: 'GetRentos Trust & Safety',
    participantRole: 'Internal',
    lastMessage: 'Escalated fraud alert fa_002 needs a second reviewer.',
    lastMessageTime: '2026-08-05T09:30:00.000Z',
    unreadCount: 1,
  },
];
  ...
  conv_001: [
    {
      id: 'm1',
      senderId: 'contact',
      text: 'Can someone review the inspection report I attached?',
  ...
  conv_002: [
    {
      id: 'm1',
      senderId: 'contact',
      text: 'How long does property verification usually take?',
    ...
    },
    {
      id: 'm2',
      senderId: 'admin',
      text: 'Typically 2-3 business days once all documents are submitted.',
  ...
  conv_003: [
    {
      ...
      timestamp: '2026-08-06T10:55:00.000Z',
      read: true,
    },
    {
      id: 'm2',
      senderId: 'contact',
      text: 'Thank you for approving my license.',
  ...
  conv_004: [
    {
      id: 'm1',
      senderId: 'contact',
      text: 'Escalated fraud alert fa_002 needs a second reviewer.',
