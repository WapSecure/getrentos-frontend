import type { MusterRollState, MusterSelfAnswer } from '../api/resident';
 ...
 * the estate read "we need help". Keep this file and
 * `apps/web/lib/emergency/answerOptions.ts` identical.
 */
